        ...
        <div class="modal-content-panel bg-white rounded-4 shadow-lg" style="max-width: 460px;">
          ...
          <div class="text-center pt-4 pb-3 px-4 border-bottom border-light">
            <div class="d-inline-flex align-items-center justify-content-center rounded-circle mb-3"
              ...
              <IdCard :size="28" style="color: #4f46e5;" />
            </div>
          ...
          <div class="px-4 py-3">
            ...
            <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom border-light">
              ...
              <div>
                ...
                >
                  <Mars v-if="(student.user?.gender || '') === 'Male'" :size="14" class="me-1" />
                  <Venus v-else :size="14" class="me-1" />
                  {{ student.user?.gender || '—' }}
                </span>
              </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center py-2 border-bottom border-light">
              ...
              <span class="text-dark fw-semibold">
                <span class="badge bg-info-subtle text-info-emphasis rounded-pill px-3 py-2">
                  <Bookmark :size="14" class="me-1" />{{ student.class?.name || 'Not assigned' }}
                </span>
              </span>
            </div>
            <div class="d-flex justify-content-between align-items-center py-2 border-bottom border-light">
              ...
              <span class="text-dark fw-semibold">
                <Mars v-if="(student.user?.gender || '') === 'Male'" :size="14" class="me-1 text-primary" />
                <Venus v-else :size="14" class="me-1 text-danger" />
                {{ student.user?.gender || '—' }}
              </span>
            </div>
            <div class="d-flex justify-content-between align-items-center py-2 border-bottom border-light">
          ...
          <div class="d-flex px-4 pb-4 pt-2 gap-2">
            <button
              ...
              @click="$emit('close')"
            >
              <CheckCircle :size="16" class="me-2" />Close
            </button>
          </div>
        </div>
      </div>
...
import { IdCard, Mars, Venus, Bookmark, CheckCircle } from '@lucide/vue'
