        ...
        <div class="modal-content-panel">
          ...
          <div class="profile-section">
            <div class="profile-avatar-wrap">
              ...
              <span class="profile-status-dot" :class="(student.user?.status || '') === 'active' ? 'dot-active' : 'dot-inactive'"></span>
            </div>
            ...
            <div class="detail-card">
              <div class="detail-card-left">
                ...
                <div>
                  ...
                  <p class="detail-value" style="font-family: 'JetBrains Mono', 'Courier New', monospace; letter-spacing: 0.03em;">{{ student.studentNumberSequence?.student_number || '—' }}</p>
                </div>
              </div>
            </div>
            ...
            <div class="detail-card">
              <div class="detail-card-left">
                ...
                <div>
                  ...
                  <span
                    class="status-pill"
                    :class="(student.user?.status || '') === 'active' ? 'stat-active' : 'stat-inactive'"
                  >
                    <span class="status-dot-sm" :class="(student.user?.status || '') === 'active' ? 'sdot-active' : 'sdot-inactive'"></span>
...
const avatarGradient = computed(() => {
  ...
  if (gender === 'Female') {
    return 'background: linear-gradient(135deg, #ec4899, #be185d);'
  }
...
const genderIconStyle = computed(() => {
  ...
  if (gender === 'Female') {
    return 'background: #fce7f3; color: #ec4899;'
  }
...
.sdot-active { background: #22c55e; }
.sdot-inactive { background: #94a3b8; }
...
.modal-leave-to .modal-content-panel { transform: scale(0.92) translateY(12px); }
