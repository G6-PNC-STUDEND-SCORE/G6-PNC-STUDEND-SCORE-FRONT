<template>
  ...
  <div class="px-4 py-4">
    ...
    <ClassFormModal
      ...
      :is-edit="isEditMode"
      :name="formData.name"
      :generation-id="formData.generation_id"
      ...
      @update:generation-id="formData.generation_id = $event"
...
function openEditModal(classItem: Class) {
  ...
  Object.assign(formData, {
    id: classItem.id,
    name: classItem.name,
    generation_id: classItem.generation?.id || null,
